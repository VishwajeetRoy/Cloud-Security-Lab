...
The project was extended with a practical **GRC and risk assessment layer** using the security findings generated by the cloud-security assessment. The assessment covers **asset identification, risk assessment, security control assessment, ISO/IEC 27001 and NIST CSF 2.0 mapping, gap assessment, remediation tracking, and audit evidence management**.
...
│   └── Evidence/
│       ├── F-01-S3-Public-Access/
│       ├── F-02-IAM-Permissions/
│       ├── F-03-Security-Group/
│       ├── F-04-S3-Encryption/
│       └── F-05-CloudTrail/
│
...
The technical cloud-security assessment was extended with a practical GRC layer based on the five security findings identified during testing.
...
| Artifact | Purpose |
|---|---|
| Asset Register | Identifies AWS resources and supporting security assets within assessment scope |
| Risk Register | Assesses likelihood, impact, inherent risk, remediation, and residual risk |
| Control Assessment | Documents security controls, assessment methods, control status, and verification |
| ISO 27001 Mapping | Maps relevant controls to ISO/IEC 27001:2022 Annex A |
| NIST CSF Mapping | Maps relevant controls and risk activities to NIST CSF 2.0 |
| Gap Assessment | Identifies technical, documentation, evidence, and process gaps |
| Remediation Tracker | Tracks remediation actions and verification results |
| Evidence | Organizes technical evidence supporting findings, remediation, and verification |

## Assessment Scope

The GRC assessment covers the AWS cloud-security laboratory and its supporting Terraform, automated detection, and security evidence components.

The assessment demonstrates selected technical and documentation aspects of GRC practices. It is **not an enterprise compliance audit, ISO 27001 certification audit, or declaration of full compliance with ISO 27001 or NIST CSF**.
...
### GRC & Risk Management 
- Asset identification and asset register development 
- Risk assessment based on actual cloud security findings 
- Qualitative likelihood and impact assessment 
- Security control assessment and control effectiveness verification 
- ISO/IEC 27001:2022 Annex A control mapping 
- NIST Cybersecurity Framework (CSF) 2.0 mapping 
- Security gap assessment 
- Remediation tracking and verification 
- Audit evidence organization and traceability 
- End-to-end traceability from **finding → risk → control → framework → gap → remediation → evidence**
